...
import type {
  ConduitInterface,
  ConduitInterfaceInterface,
} from "../../../contracts/interfaces/ConduitInterface";
...
export class ConduitInterface__factory {
  ...
  static createInterface(): ConduitInterfaceInterface {
    return new utils.Interface(_abi) as ConduitInterfaceInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ConduitInterface {
    return new Contract(address, _abi, signerOrProvider) as ConduitInterface;
  }
}
