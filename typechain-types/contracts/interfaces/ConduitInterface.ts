...
export interface ConduitInterfaceInterface extends utils.Interface {
  functions: {
...
export interface ConduitInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConduitInterfaceInterface;
  ...
  functions: {
    ...
    executeBatch1155(
      batch1155Transfers: ConduitBatch1155TransferStruct[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
